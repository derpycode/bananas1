...
Spend a little time working through the code in your head and making sure you are happy how it works.

Create a \uline{new} \textit{script} \textbf{m-file} and add this code to it (plus comments!).

To crudely visualize the result (array contents), after the nested loop has ended (after the very last \texttt{end}), you could using the e.g. \texttt{imagesc} function (cf. Figure \ref{fig:ch8-chess} and refer back to the syntax of how to visualize array contents using this \textit{function}). Beautiful!
